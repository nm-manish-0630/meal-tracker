...
- Meal-type edits and deletions remain entirely out of scope here — unchanged from the original PRD, they stay dashboard-only. Only _new photos_ on a meal within the 7-day window trigger delivery
